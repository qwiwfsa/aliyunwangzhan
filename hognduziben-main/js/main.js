...
(function() {
    ...
    document.addEventListener('click', function(e) {
        ...
        if (bookingWrapper && !bookingWrapper.contains(e.target)) {
            const card = bookingWrapper.querySelector('.contact-card');
            const button = bookingWrapper.querySelector('#bookingBtn');
    ...
    function initChatWidget() {
        ...
        chatBtn.addEventListener('click', () => {
            const isExpanded = chatBtn.getAttribute('aria-expanded') === 'true';
            chatBtn.setAttribute('aria-expanded', !isExpanded);
            chatPopup.classList.toggle('active');
            chatPopup.setAttribute('aria-hidden', isExpanded);
        });
        ...
        document.addEventListener('click', (e) => {
            if (!chatWidget.contains(e.target) && chatPopup.classList.contains('active')) {
                chatBtn.setAttribute('aria-expanded', 'false');
                chatPopup.classList.remove('active');
                chatPopup.setAttribute('aria-hidden', 'true');
            }
